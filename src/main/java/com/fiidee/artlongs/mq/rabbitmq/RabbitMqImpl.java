 ...
 */
public class RabbitMqImpl extends MqBase implements MQ {
    ...
    private static SnowflakeIdWorker snowflakeIdWorker = new SnowflakeIdWorker(0, 0);; // Twitter_Snowflake ID生成器

    private static ISerializer serializer;


    public RabbitMqImpl init(MqConfig config,EventBus eventBus,ISerializer serializer) {
